...
#---------------Variable Setting---------------
# Publish할 토픽 이름
PUB_TOPIC_NAME = 'camera_front_down/image_raw'
...
IMAGE_DIRECTORY_PATH = 'src/lane_tracking_pkg/lane_tracking_pkg/lib/Collected_Datasets/sample_dataset'

# 비디오 데이터 파일의 경로를 입력
VIDEO_FILE_PATH = 'src/lane_tracking_pkg/lane_tracking_pkg/lib/Collected_Datasets/driving_simulation.mp4'
